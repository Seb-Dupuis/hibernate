package fr.hibernatecours.hibernatewild.utils;
...
import fr.hibernatecours.hibernatewild.repositories.UserDao;
...
public class Outputter implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User user1 = new User("Nathanielle", "Wildeuse", 193);
        LOG.info("******************");
        ...
        User user2 = new User("Bryan", "Wilder", 33);
        LOG.info("******************");
        LOG.info(user2 + " has been created !");
        userDao.save(user2);
        LOG.info(user2 + " has been saved !");

        User user3 = new User("Bryanette", "Wildeuse", 19);
        LOG.info("******************");
